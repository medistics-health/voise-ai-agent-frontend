          ...
          {file ? (
            <>
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1 font-medium">{sizeKb} KB</p>
              </div>
              <button
            ...
            <>
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${dragging ? 'bg-brand-100 border border-brand-200' : 'bg-slate-100 border border-slate-200'}`}>
                <UploadIcon size={28} className={dragging ? 'text-brand-600' : 'text-slate-400'} />
              </div>
              <div>
                <p className="text-slate-900 font-bold">
                  {dragging ? 'Drop your file here' : 'Drag & drop your CSV here'}
                </p>
                <p className="text-slate-500 text-sm mt-1 font-medium">or click to browse</p>
              </div>
              <p className="text-xs font-semibold text-slate-400">Max 500 rows · Max 5 MB</p>
            </>
          )}
        </div>
      </div>
