type Status = 'ELIGIBLE' | 'NOT_ELIGIBLE' | 'ERROR' | 'PENDING' | 'RUNNING' | 'COMPLETED' | 'FAILED' | 'QUEUED'

const map: Record<Status, { label: string; className: string }> = {
  ELIGIBLE: { label: 'Eligible', className: 'bg-success-100 text-success-600 border-success-600/20' },
  QUEUED: { label: 'Moved to Queue Management', className: 'bg-brand-100 text-brand-700 border-brand-300' },
  ...
  PENDING: { label: 'Uploaded', className: 'bg-brand-50 text-brand-700 border-brand-200' },
